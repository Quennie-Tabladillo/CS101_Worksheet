...
#Tacloban, Samal Island, and Davao City. The average temperatures in Celcius are 42, 39, 34, 34, 30, and 27 degrees.

#a.	What is the R code and its result for creating a character vector for the city/town 
#ofTuguegarao City, Manila, Iloilo City, Tacloban, Samal Island, and Davao City? Name the object as city.
...
# new dimension with dim().New dimensions should have 2 columns and 6 rows. What will be the R code amd its output?
```{r 2h}
dim(x2) <- c(6,2)
x2
```
...
#a.Create an array for the above numeric values. Each values will be repeated twice.What will be
# the R code if you are to create a three-dimensional array with 4 columns and 2 rows. What will be its output?
```{r 3a}
