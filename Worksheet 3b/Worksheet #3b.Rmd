...
```{r 1g}
#Write the codes and its output.
subset(People, Sex == 1, select = c(Sex, Fathers_Occupation))
```

>h.Select only all females respondent that have greater than or equal to 5 
number of siblings attending school.
```{r 1h}
...
```{r 3}
#The graph is about the sentiments for former US President Donald Trump.
